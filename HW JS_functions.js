...
function CheckList(web_ui) {
    let arr = [['Ввести номер телефона состоящий только из цифр','вести номер делефона с граничными значениями','вести пробел'],['выбрать один чекбокс', 'выбрать несколько чекбоксов','оставить все чекбоксы не выбраными'],['нажать на кнопку SignIn',' нажать и удерживать кнопку SignIn','нажать кнопку SignIn двойным щелчком кнопки мыши']]
